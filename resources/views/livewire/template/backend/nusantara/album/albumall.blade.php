                ...
                <div class="box box-bordered border-primary">
                    <div class="box-header with-border">
                        ...
                        <div class="box-controls pull-right">
                                    <a class="btn btn-sm btn-primary" href="{{ route('backend.albums.create') }}"><i class="ti-plus"></i> Add</a>
                        </div>
                    </div>
                    <div class="box-body">
                        <div class="row mb-2">
                        ...
                        <div class="row mb-2"> <!-- row count selected item -->
                            <div class="col-xl-12 col-md-12 col-lg-12 col-12">
                                ...
                                <div class="col-md-10 mb-2">
                                    @if ($selectAll)
                                    <div>
                                        You have selected all <strong>{{ $dataalbumall->total() }}</strong> items.
                                    </div>
                                    @else
                                    <div>
                                        You have selected <strong>{{ count($checked) }}</strong> items, Do you want to Select All
                                        <strong>{{ $dataalbumall->total() }}</strong>?
                            ...
                            <div class="col-xl-12 col-md-12 col-lg-12 col-12">
                                    ...
                                    <table class="table table-hover mb-0">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="@if ($this->isChecked($item->id))
                                                table-primary
                                                @endif">
                                                <th class="text-right" scope="row">{{ $no + $dataalbumall->firstItem() }}</th>
                                                {{-- <td>
                                                    <div class="checkbox">
                                                        <input type="checkbox" id="Checkbox_{{ $no + $dataalbumall->firstItem() }}" value="{{ $item->id }}" wire:model="checked">
                                                        <label for="Checkbox_{{ $no + $dataalbumall->firstItem() }}"></label>
                                                    </div>
                                                </td> --}}
                                                <td width="10%">
                                                ...
                                                <td class="text-center align-midle">
                                                    ...
                                                    @endif
                                                    <a title="Edit" class="btn btn-xs btn-warning edit-row" href="{{route('backend.albums.edit', $item->id)}}">
                                ...
                                <div class="mt-3 row">
                                    ...
                                    <div class="col-xl-5 col-md-5 col-lg-5 col-12 text-center">
                                        Page : {{ $dataalbumall->currentPage() }} | Show {{ $dataalbumall->count() }} data of {{ $dataalbumall->total() }}
                                    </div>
                                </div>
                                @else
                                <hr>
