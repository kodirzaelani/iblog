                ...
                <div class="box box-bordered border-primary">
                    <div class="box-header with-border">
                        ...
                        <div class="box-controls pull-right">
                            <a class="btn btn-sm btn-primary" href="{{ route('backend.fotos.create') }}"><i class="ti-plus"></i> Add</a>
                        ...
                        <div class="row mb-2"> <!-- row count selected item -->
                            <div class="col-xl-12 col-md-12 col-lg-12 col-12">
                                ...
                                <div class="col-md-10 mb-2">
                                    @if ($selectAll)
                                    <div>
                                        You have selected all <strong>{{ $datafotoall->total() }}</strong> items.
                                    </div>
                                    @else
                                    <div>
                            ...
                            <div class="col-xl-12 col-md-12 col-lg-12 col-12">
                                    ...
                                    <table class="table table-hover mb-0">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="@if ($this->isChecked($item->id))
                                                table-primary
                                                @endif">
                                                <th class="text-right" scope="row">{{ $no + $datafotoall->firstItem() }}</th>
                                                {{-- <td>
                                                    <div class="checkbox">
                                                ...
                                                <td class="text-center align-midle">
                                                    ...
                                                    @endif
                                                    <a title="Edit" class="btn btn-xs btn-warning edit-row" href="{{route('backend.fotos.edit', $item->id)}}">
                                ...
                                <div class="mt-3 row">
                                    ...
                                    <div class="col-xl-5 col-md-5 col-lg-5 col-12 text-center">
                                        Page : {{ $datafotoall->currentPage() }} | Show {{ $datafotoall->count() }} data of {{ $datafotoall->total() }}
                                    </div>
                                </div>
                                @else
                                <hr>
