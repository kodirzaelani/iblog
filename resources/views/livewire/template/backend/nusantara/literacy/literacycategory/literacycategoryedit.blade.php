        ...
        <form enctype="multipart/form-data" wire:submit.prevent="update">
            <div class="box-body">
                ...
                <div class="mb-3">
                    ...
                    <p>
                        <img class="w-80 rounded" src="{{ asset('') }}uploads/images/literacycategory/images_thumb/{{ ($prevImage) ? $prevImage : '/assets/images/no_image.png' }}"  alt="...">
                    </p>
                </div>
                <div class="mb-3">
            ...
            <div class="box-footer flexbox">
                <div class="text-end flex-grow">
                    <a class="btn btn-sm btn-info mr-20" href="{{ route('backend.literacycategories.index') }}"><i class="fa fa-undo" aria-hidden="true"></i> Cancel</a>
