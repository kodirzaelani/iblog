                ...
                <div class="box box-bordered border-primary">
                    <div class="box-header with-border">
                        ...
                        <div class="box-controls pull-right">
                            <a class="btn btn-primary btn-xs" href="{{ route('backend.video.create') }}"><i class="ti-plus"></i> Add</a>
                        </div>
                    </div>
                    <div class="box-body">
                        <div class="row mb-2">
                        ...
                        <div class="row mb-2"> <!-- row count selected item -->
                            <div class="col-xl-12 col-md-12 col-lg-12 col-12">
                                ...
                                <div class="col-md-10 mb-2">
                                    @if ($selectAll)
                                    <div>
                                        You have selected all <strong>{{ $datavideoall->total() }}</strong> items.
                                    </div>
                                    @else
                                    <div>
                            ...
                            <div class="col-xl-12 col-md-12 col-lg-12 col-12">
                                    ...
                                    <table class="table table-hover mb-0">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="@if ($this->isChecked($item->id))
                                                table-primary
                                                @endif">
                                                <th class="text-right" scope="row">{{ $no + $datavideoall->firstItem() }}</th>
                                                {{-- <td>
                                                    <div class="checkbox">
                                                ...
                                                <td>
                                                    ...
                                                    <span class="text-success">{{ !empty($item->videocategory_id) ? $item->videocategory->title:'' }}</span> | <span class="text-primary">{{ TanggalID("j M Y", $item->created_at) }}</span>
                                                </td>
                                                {{-- <td width="10%">
                                                    {!! $item->statuslabel !!}
                                                </td> --}}
                                                ...
                                                <td class="text-center align-midle">
                                                    ...
                                                    @endif
                                                    <a title="Edit" class="btn btn-xs btn-warning edit-row" href="{{route('backend.video.edit', $item->id)}}">
                                ...
                                <div class="mt-3 row">
                                    ...
                                    <div class="col-xl-5 col-md-5 col-lg-5 col-12 text-center">
                                        Page : {{ $datavideoall->currentPage() }} | Show {{ $datavideoall->count() }} data of {{ $datavideoall->total() }}
                                    </div>
                                </div>
                                @else
                                <hr>
