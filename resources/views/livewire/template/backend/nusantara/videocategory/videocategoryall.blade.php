                        ...
                        <div class="row mb-2"> <!-- row count selected item -->
                            <div class="col-xl-12 col-md-12 col-lg-12 col-12">
                                ...
                                <div class="col-md-10 mb-2">
                                    @if ($selectAll)
                                    <div>
                                        You have selected all <strong>{{ $datavideocategoryall->total() }}</strong> items.
                                    </div>
                                    @else
                                    <div>
                            ...
                            <div class="col-xl-8 col-md-8 col-lg-8 col-12">
                                    ...
                                    <table class="table table-hover mb-0">
                                        <tbody>
                                            <tr>
                                                ...
                                                @endforeach
                                                <th scope="col" width="20%" class="text-center">Video Count</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <th class="text-right" scope="row">{{ $no + $datavideocategoryall->firstItem() }}</th>
                                                <td>
                                ...
                                <div class="mt-3 row">
                                    <div class="col-xl-12 col-md-12 col-lg-12 col-12 ">
                                        ...
                                        Page : {{ $datavideocategoryall->currentPage() }} | Show {{ $datavideocategoryall->count() }} data of {{ $datavideocategoryall->total() }}
                                    </div>
