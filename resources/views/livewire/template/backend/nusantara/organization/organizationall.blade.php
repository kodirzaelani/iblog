                ...
                <div class="box box-bordered border-primary">
                    <div class="box-header with-border">
                        ...
                        <div class="box-controls pull-right">
                            <a class="btn btn-sm btn-primary " href="{{ route('backend.organizations.create') }}"><i class="ti-plus"></i> Add</a>
                        </div>
                    </div>
                    <div class="box-body">
                        <div class="row mb-2">
                        ...
                        <div class="row mb-2"> <!-- row count selected item -->
                            <div class="col-xl-12 col-md-12 col-lg-12 col-12">
                                ...
                                <div class="col-md-10 mb-2">
                                    @if ($selectAll)
                                    <div>
                                        You have selected all <strong>{{ $dataorganizationall->total() }}</strong> items.
                                    </div>
                                    @else
                                    <div>
                            ...
                            <div class="col-xl-12 col-md-12 col-lg-12 col-12">
                                    ...
                                    <table class="table table-hover mb-0">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="@if ($this->isChecked($item->id))
                                                table-primary
                                                @endif">
                                                <th class="text-right" scope="row">{{ $no + $dataorganizationall->firstItem() }}</th>

                                                <td width="16%">
                                                    <img class="w-80 rounded" src="{{ ($item->imageThumbUrl) ? $item->imageThumbUrl : '/assets/images/no_image.png' }}"  alt="..."><br>
                                                </td>
                                                <td>
                                                    <a title="Show"  href="{{ route('page.detail', $item->slug) }}" target="_blank" style="text-decoration: none; color:#212529;">
                                                ...
                                                <td class="text-center align-midle">
                                                    ...
                                                    <a title="Edit" class="btn btn-xs btn-warning edit-row" href="{{route('backend.organizations.edit', $item->id)}}">
                                ...
                                <div class="mt-3 row">
                                    ...
                                    <div class="col-xl-5 col-md-5 col-lg-5 col-12 text-center">
                                        Page : {{ $dataorganizationall->currentPage() }} | Show {{ $dataorganizationall->count() }} data of {{ $dataorganizationall->total() }}
                                    </div>
                                </div>
                                @else
                                <hr>
