                            ...
                            <div class="col-xl-8 col-md-8 col-lg-8 col-12">
                                    ...
                                    <table class="table editable-table table-hover mb-0">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="@if ($this->isChecked($item->id))
                                                table-primary
                                                @endif">
                                                <th class="text-right" scope="row">{{ $no + $datatag->firstItem() }}</th>
                                                <td >
                                                    <div class="checkbox">
                                                        <input type="checkbox" id="Checkbox_{{ $no + $datatag->firstItem() }}" value="{{ $item->id }}" wire:model="checked">
                                                        <label for="Checkbox_{{ $no + $datatag->firstItem() }}"></label>
                                                    </div>
                                                </td>
                                                <td>
                                ...
                                <div class="mt-3 row">
                                    ...
                                    <div class="col-xl-5 col-md-5 col-lg-5 col-12 text-center">
                                        Page : {{ $datatag->currentPage() }} | Show {{ $datatag->count() }} data of {{ $datatag->total() }}
                                    </div>
                                </div>
                                @else
                                <hr>
