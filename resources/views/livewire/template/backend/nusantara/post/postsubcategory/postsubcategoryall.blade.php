                ...
                <div class="d-inline-block align-items-center">
                    <nav>
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item" aria-current="page"><a href="{{ route('backend.postscategories.index') }}">All Post Sub Categories</a></li>
                        </ol>
                    </nav>
                </div>
            </div>
                        ...
                        <div class="row mb-2"> <!-- row count selected item -->
                            <div class="col-xl-12 col-md-12 col-lg-12 col-12">
                                ...
                                <div class="col-md-10 mb-2">
                                    @if ($selectAll)
                                    <div>
                                        You have selected all <strong>{{ $datapostsubcategory->total() }}</strong> items.
                                    </div>
                                    @else
                                    <div>
                            ...
                            <div class="col-xl-8 col-md-8 col-lg-8 col-12">
                                    ...
                                    <table class="table table-hover mb-0">
                                        <tbody>
                                            <tr>
                                                ...
                                                @endforeach
                                                <th scope="col" width="20%" class="text-center">Post Count</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="@if ($this->isChecked($item->id))
                                                table-primary
                                                @endif">
                                                <th class="text-right" scope="row">{{ $no + $datapostsubcategory->firstItem() }}</th>
                                                {{-- <td>
                                                    <div class="checkbox">
                                                ...
                                                <td>
                                                    ...
                                                    <a title="Show Post"  href="{{ route('post.subcategory', $item->postcategory->slug) }}" target="_blank" style="text-decoration: none; color:#212529;">
                                                ...
                                                <td>
                                                    <a title="Show Post"  href="{{ route('post.category', $item->postcategory->slug) }}" target="_blank" style="text-decoration: none; color:#212529;">
                                ...
                                <div class="mt-3 row">
                                    ...
                                    <div class="col-xl-5 col-md-5 col-lg-5 col-12 text-center">
                                        Page : {{ $datapostsubcategory->currentPage() }} | Show {{ $datapostsubcategory->count() }} data of {{ $datapostsubcategory->total() }}
                                    </div>
                                </div>
                                @else
                                <hr>
