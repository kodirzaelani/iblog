                        ...
                        <tbody>
                            ...
                            <tr class="@if ($this->isChecked($item->id))
                                ...
                                <td class="text-center align-midle">
                                    ...
                                    <button wire:click="selectItem('{{ $item->id }}', 'restore')" class="btn btn-sm btn-warning" title="Restore"><i class="fa fa-undo    "></i></button>
                                    <button wire:click="selectItem('{{ $item->id }}' , 'delete')"  class="btn btn-sm btn-danger mx-1 my-1" title="Force Delete"><i class="fa fa-times    "></i></button>
                                    @else
                                    <button class="btn btn-sm btn-warning" title="Forbidden" disabled><i class="fa fa-undo    "></i></button>
                                    <button  class="btn btn-sm btn-danger mx-1 my-1" title="Forbidden" disabled><i class="fa fa-times    "></i></button>
                                    @endif
                                </td>
                            </tr>
                            @endforeach
    ...
    <div class="modal center-modal fade" id="modalFormRestore" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    {{-- Selected Item {{ $selectedItem }} --}}
                    <p><h3>Do you wish to continue restore?</h3></p>
                </div>
                <div class="modal-footer modal-footer-uniform">
                    <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Cancel</button>
