                ...
                <div class="d-inline-block align-items-center">
                    <nav>
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item" aria-current="page"><a href="{{ route('backend.postscategories.index') }}">All Post Categories</a></li>
                        </ol>
                    </nav>
                </div>
            </div>
                        ...
                        <div class="row mb-2"> <!-- row count selected item -->
                            <div class="col-xl-12 col-md-12 col-lg-12 col-12">
                                ...
                                <div class="col-md-10 mb-2">
                                    @if ($selectAll)
                                    <div>
                                        You have selected all <strong>{{ $datapostcategory->total() }}</strong> items.
                                    </div>
                                    @else
                                    <div>
                            ...
                            <div class="col-xl-8 col-md-8 col-lg-8 col-12">
                                    ...
                                    <table class="table table-hover mb-0">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="@if ($this->isChecked($item->id))
                                                ...
                                                <td>
                                                    <a title="Show"  href="{{ route('post.category', $item->slug) }}" target="_blank" style="text-decoration: none; ">
                                                        {{ !empty($item->title) ? $item->title:'' }}
                                                    </a>
                                                    <br>
                                                    <small>
                                                        Subcategory: [{{ $item->postsubcategories->count()}}]
                                                    </small>
                                                </td>
                                                <td class="text-right">
                                                    {{ $item->posts->count()}}
                                ...
                                <div class="mt-3 row">
                                    ...
                                    <div class="col-xl-5 col-md-5 col-lg-5 col-12 text-center">
                                        Page : {{ $datapostcategory->currentPage() }} | Show {{ $datapostcategory->count() }} data of {{ $datapostcategory->total() }}
                                    </div>
                                </div>
                                @else
                                <hr>
