                ...
                <div class="d-inline-block align-items-center">
                    <nav>
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item" aria-current="page"><a href="{{ route('backend.menu.index') }}">All @yield('title')</a></li>
                        </ol>
                    </nav>
                </div>
            </div>
                        ...
                        <div class="row mb-2"> <!-- row count selected item -->
                            <div class="col-xl-12 col-md-12 col-lg-12 col-12">
                                ...
                                <div class="col-md-10 mb-2">
                                    @if ($selectAll)
                                    <div>
                                        You have selected all <strong>{{ $datamenucategory->total() }}</strong> items.
                                    </div>
                                    @else
                                    <div>
                            ...
                            <div class="col-xl-8 col-md-8 col-lg-8 col-12">
                                    ...
                                    <table class="table table-hover mb-0">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="@if ($this->isChecked($item->id))
                                                table-primary
                                                @endif">
                                                <th class="text-right" scope="row">{{ $no + $datamenucategory->firstItem() }}</th>
                                                <td>
                                                    {{ !empty($item->name) ? $item->name:'' }}
                                                </td>
                                                <td class="text-center align-midle">
                                                    <a href="{{ route('backend.menuitem.index') }}"  class="btn btn-xs btn-primary" title="List Menu Items"><i class="fa fa-list" aria-hidden="true"></i></a>
                                                    {{-- @if ($item->status == 1)
                                ...
                                <div class="mt-3 row">
                                    ...
                                    <div class="col-xl-5 col-md-5 col-lg-5 col-12 text-center">
                                        Page : {{ $datamenucategory->currentPage() }} | Show {{ $datamenucategory->count() }} data of {{ $datamenucategory->total() }}
                                    </div>
                                </div>
                                @else
                                <hr>
