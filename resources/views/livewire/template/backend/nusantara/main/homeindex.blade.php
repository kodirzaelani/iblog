            ...
            <div class="col-xl-3 col-12">
                <div class="box bg-transparent no-shadow">
                    <div class="box-body p-xl-0 text-center">
                        ...
                        <a href="{{ route('backend.posts.create') }}" class="waves-effect waves-light w-p100 btn btn-primary"><i class="fa fa-plus me-15"></i> Cheate New Post</a>
                        @else
                        <button type="button" class="waves-effect waves-light w-p100 btn btn-default" title="No Permission"><i class="fa fa-plus me-15"></i> Cheate New Post</button>
                        @endif
                    </div>
                </div>
            </div>
                        ...
                        <!-- Place somewhere in the <body> of your page -->
                            <div class="flexslider">
                                <ul class="slides">
                                    ...
                                    <li>
                                        <iframe width="415" height="275" src="https://www.youtube.com/embed/{{ $item->video }}" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                            ...
                            <!-- Place somewhere in the <body> of your page -->
                                <div class="flexslider">
                                    <ul class="slides">
                                        ...
                                        <li>
                                            <img src="{{ ($item->imageUrl) ? $item->imageUrl : '/assets/images/no_image.png' }}"  alt="slide">
                                            <p class="flex-caption">{{ $item->title }}</p>
                                        </li>
                                        @endforeach
                                    </ul>
