                ...
                <div class="row g-5">
                    ...
                    <div class="col-lg-8">
                        ...
                        <article class="blog-details">
                            <h2 class="title p-4">Dolorum optio tempore voluptas dignissimos cumque fuga qui quibusdam
                                quia
                            </h2>

                            <div class="meta-top ps-4">
                                <ul>
                            ...
                            <div class="meta-bottom px-4 pb-4">
                    ...
                    <div class="col-lg-4">
                        ...
                        @livewire('template.frontend.terasblue.partials.sidebarpagedetail')
