<div>
    {{-- mainpost --}}
    <main>
        <section id="post-home" class="post-home">
            <div class="row">
                ...
                <div class="col-xl-6 col-lg-6 col-md-6 col-12 mb-4">
                    <div class="card h-100 shadow-sm border-0 rounded-lg">
                        <img src="{{ asset('') }}assets/frontend/images/blog/blog-1.jpg" class="card-img-top"
                            alt="...">
                        ...
                        <div class="card-body">
                            <a href="{{ route('frontend.post.detail') }}">
                                <h6 class="card-title">Lorem ipsum dolor sit amet, consectetur adipisicing elit Lorem
                                    ipsum
                ...
                <div class="text-center py-4">
                    <a href="{{ route('frontend.post.all') }}" class="btn-get-started scrollto">Update lainnya</a>
                </div>
                <!-- end berita section -->

                @livewire('template.frontend.terasblue.album.falbumhome')
                @livewire('template.frontend.terasblue.video.fvideohome')
