...
<head>
    ...
    <link rel="icon" href="{{ asset('') }}assets/backend/nusantara/images/favicon.ico">
...
<body class="hold-transition light-skin sidebar-mini theme-primary fixed">
                ...
                <a href="index.html" class="logo">
                    ...
                    <div class="logo-lg">
                        <span class="light-logo"><img
                                src="{{ asset('') }}assets/backend/nusantara/images/logo-dark-text.png"
                                alt="logo"></span>
                        <span class="dark-logo"><img
                                src="{{ asset('') }}assets/backend/nusantara/images/logo-light-text.png"
                                alt="logo"></span>
                    </div>
                </a>
            </div>
                                ...
                                <div class="box-body pe-0 ps-lg-50 ps-15 py-0">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-12 col-lg-4"><img
                                                src="{{ asset('') }}assets/backend/nusantara/images/svg-icon/color-svg/custom-15.svg"
                                                alt=""></div>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="d-flex align-items-center justify-content-between mt-10">
                                            <div class="d-flex">
                                                <a href="#"
                                                    ...
                                                    <img src="{{ asset('') }}assets/backend/nusantara/images/avatar/avatar-1.png"
                                                        class="h-50 align-self-end" alt="">
                                                </a>
                                                <a href="#"
                                                    class="me-15 bg-lightest h-50 w-50 l-h-50 rounded-circle text-center overflow-hidden">
                                                    <img src="{{ asset('') }}assets/backend/nusantara/images/avatar/avatar-3.png"
                                                        class="h-50 align-self-end" alt="">
                                                </a>
                                                <a href="#"
                                                    class="me-15 bg-lightest h-50 w-50 l-h-50 rounded-circle text-center overflow-hidden">
                                                    <img src="{{ asset('') }}assets/backend/nusantara/images/avatar/avatar-4.png"
                                                        class="h-50 align-self-end" alt="">
                                                </a>
                                            </div>
                                            <button type="button"
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between mt-10">
                                            <div class="d-flex">
                                                <a href="#"
                                                    class="me-15 bg-lightest h-50 w-50 l-h-50 rounded-circle text-center overflow-hidden">
                                                    <img src="{{ asset('') }}assets/backend/nusantara/images/avatar/avatar-2.png"
                                                        class="h-50 align-self-end" alt="">
                                                </a>
                                                <a href="#"
                                                    class="me-15 bg-lightest h-50 w-50 l-h-50 rounded-circle text-center overflow-hidden">
                                                    <img src="{{ asset('') }}assets/backend/nusantara/images/avatar/avatar-5.png"
                                                        class="h-50 align-self-end" alt="">
                                                </a>
                                                <a href="#"
                                                    class="me-15 bg-lightest h-50 w-50 l-h-50 rounded-circle text-center overflow-hidden">
                                                    <img src="{{ asset('') }}assets/backend/nusantara/images/avatar/avatar-6.png"
                                                        class="h-50 align-self-end" alt="">
                                                </a>
                                            </div>
                                            <button type="button"
                    ...
                    <div class="media-list media-list-hover mt-20">
                        <div class="media py-10 px-0">
                            <a class="avatar avatar-lg status-success" href="#">
                                <img src="{{ asset('') }}assets/backend/nusantara/images/avatar/1.jpg"
                                    alt="...">
                            </a>
                        ...
                        <div class="media py-10 px-0">
                            <a class="avatar avatar-lg status-danger" href="#">
                                <img src="{{ asset('') }}assets/backend/nusantara/images/avatar/2.jpg"
                                    alt="...">
                            </a>
                            <div class="media-body">
                                <p class="fs-16">
                        ...
                        <div class="media py-10 px-0">
                            <a class="avatar avatar-lg status-warning" href="#">
                                <img src="{{ asset('') }}assets/backend/nusantara/images/avatar/3.jpg"
                                    alt="...">
                            </a>
                            <div class="media-body">
                                <p class="fs-16">
                        ...
                        <div class="media py-10 px-0">
                            <a class="avatar avatar-lg status-primary" href="#">
                                <img src="{{ asset('') }}assets/backend/nusantara/images/avatar/4.jpg"
                                    alt="...">
                            </a>
                            <div class="media-body">
                                <p class="fs-16">
    ...
    <script src="{{ asset('') }}assets/backend/nusantara/assets/icons/feather-icons/feather.min.js"></script>

    <script
        src="{{ asset('') }}assets/backend/nusantara/assets/vendor_components/apexcharts-bundle/dist/apexcharts.js">
    </script>

    <!-- EduAdmin App -->
    <script src="{{ asset('') }}assets/backend/nusantara/js/template.js"></script>
    <script src="{{ asset('') }}assets/backend/nusantara/js/pages/dashboard4.js"></script>
    @livewireScripts
