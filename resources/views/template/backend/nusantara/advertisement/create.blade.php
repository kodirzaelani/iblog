            ...
            <div class="d-inline-block align-items-center">
                <nav>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item" aria-current="page"><a href="{{ route('backend.advertisements.index') }}">All Page</a></li>
...
<section class="content">
    <form id="post-form" enctype="multipart/form-data" action="{{ route('backend.advertisements.store') }}" method="post">
        <div class="row">
            @csrf
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="demo-radio-button">
                                <input value= "1" name="position" type="radio" id="radio_30" class="with-gap radio-col-success" checked />
                                <label for="radio_30">Home Top</label>
                                <input value= "2" name="position" type="radio" id="radio_32" class="with-gap radio-col-success" />
                                <label for="radio_32">Home Midle</label>
                                <input value= "3" name="position" type="radio" id="radio_33" class="with-gap radio-col-success" />
                                <label for="radio_33">Home Bottom</label>
                                <input value= "4" name="position" type="radio" id="radio_34" class="with-gap radio-col-success" />
                                <label for="radio_34">Sidebar Right Top</label>
                                <input value= "5" name="position" type="radio" id="radio_35" class="with-gap radio-col-success" />
                                <label for="radio_35">Sidebar Right Midle</label>
                                <input value= "6" name="position" type="radio" id="radio_36" class="with-gap radio-col-success" />
                                <label for="radio_36">Sidebar Right Bottom</label>
                                <input value= "7" name="position" type="radio" id="radio_37" class="with-gap radio-col-success" />
                                <label for="radio_37">Sidebar Left Top</label>
                                <input value= "8" name="position" type="radio" id="radio_38" class="with-gap radio-col-success" />
                                <label for="radio_38">Sidebar Left Midlle</label>
                                <input value= "9" name="position" type="radio" id="radio_39" class="with-gap radio-col-success" />
                        ...
                        <div class="form-group">
                            ...
                            <textarea  rows="10" cols="80" class="form-control @error('scripthtml') is-invalid @enderror" name="scripthtml" >{{ old('scripthtml') }}</textarea>
                            @error('scripthtml')
                            <div class="form-control-feedback"><small> <code>{{ $message }}</code> </small></div>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <input id="linkimage" name="linkimage" type="text" class="form-control @error('linkimage') is-invalid @enderror" placeholder="Link untuk gambar" value="{{ old('linkimage') }}">
