...
<section class="content">
    <form id="post-form" enctype="multipart/form-data" action="{{ route('backend.download.update', $download) }}" method="post">
        @csrf
        @method('PUT')
        <div class="row">
                    ...
                    <div class="box bs-3 border-success">
                            ...
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="title" class="form-control @error('title') is-invalid @enderror"  value="{{ old('title') ?? $download->title  }}" placeholder="Title" required>
                                    </div>
                                    @error('title')
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="urlcontent" id="urlcontent" rows="5" class="form-control  @error('urlcontent') is-invalid @enderror" placeholder="URL  Content" >{{ old('urlcontent') ?? $download->urlcontent}}</textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="linkdownload" class="form-control @error('linkdownload') is-invalid @enderror" value="{{ old('linkdownload') ?? $download->linkdownload }}" placeholder="ID File" >
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea id="editor1"  rows="10" cols="80" class="form-control @error('description') is-invalid @enderror" name="description" >{{ old('description') ?? $download->description  }}</textarea>
                                    @error('description')
                                    <div class="form-control-feedback"><small> <code>{{ $message }}</code> </small></div>
                                    @enderror
                                </div>
                        ...
                        <div class="form-group form-group-float">
                            <select  name="downloadcategory_id" class="form-select @error('downloadcategory_id') is-invalid @enderror">
                                ...
                                <option value="{{ $item->id }}" 
                                 @if($item->id == $download->downloadcategory_id)
                                    selected
