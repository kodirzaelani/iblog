            ...
            <div class="d-inline-block align-items-center">
                <nav>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item" aria-current="page"><a href="{{ route('backend.organizations.index') }}">All Page</a></li>
...
<section class="content">
    <form id="post-form" enctype="multipart/form-data" action="{{ route('backend.organizations.store') }}" method="post">
        <div class="row">
            @csrf
                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="controls">
                                <input type="text" name="singkatan" class="form-control @error('singkatan') is-invalid @enderror" value="{{ old('singkatan')  }}" placeholder="Singkatan" required>
                            </div>
                            @error('singkatan')
                            <div class="form-control-feedback"><small> <code>{{ $message }}</code> </small></div>
                            @enderror
                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="controls">
                                <input type="text" name="urut" class="form-control @error('urut') is-invalid @enderror" value="{{ old('urut')  }}" placeholder="Urutan" required>
                            </div>
                            @error('urut')
                            <div class="form-control-feedback"><small> <code>{{ $message }}</code> </small></div>
                            @enderror
