            ...
            <div class="d-inline-block align-items-center">
                <nav>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item" aria-current="page"><a href="{{ route('backend.fotos.index') }}">All Page</a></li>
                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="editor1"  rows="10" cols="80" class="form-control @error('excerpt') is-invalid @enderror" name="excerpt" >{{ old('excerpt') }}</textarea>
                            @error('excerpt')
                            <div class="form-control-feedback"><small> <code>{{ $message }}</code> </small></div>
                            @enderror
                        </div>
                    ...
                    <div class="box-body">
                        <div class="form-group @error('album_id') has-error @enderror">
                            ...
                            <select class="form-control select2" style="width: 100%;" name="album_id">
                                ...
                                <option value="{{ $item->id }}" {{ (old('album_id') == $item->id ? 'selected': '') }}>{{ $item->title }}</option>
                                @endforeach
                            </select>
                            @error('album_id')
