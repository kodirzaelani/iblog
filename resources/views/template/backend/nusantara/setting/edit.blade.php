...
<section class="content">
    ...
    <form id="post-form" enctype="multipart/form-data" action="{{ route('backend.settings.update', $option) }}" method="post">
        @method('PUT')
        @csrf
        <div class="row">
            <div class="col-12">
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <ul class="nav nav-tabs customtab2" role="tablist">
                            ...
                            <li class="nav-item"> <a class="nav-link" data-bs-toggle="tab" href="#logo7" role="tab"><span class="hidden-sm-up"><i class="ion-email"></i></span> <span class="hidden-xs-down">Image</span></a> </li>
                                    ...
                                    <div class="box">
                                        ...
                                        <div class="box-body">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" name="webname" class="form-control @error('webname') is-invalid @enderror" value="{{ old('webname') ?? $option->webname}}" placeholder="Web Title" required>
                                                </div>
                                                @error('webname')
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" name="tagline" class="form-control @error('tagline') is-invalid @enderror" value="{{ old('tagline') ?? $option->tagline }}" placeholder="Moto situs bisa diletakkan di sini" required>
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="url" name="siteurl" class="form-control @error('siteurl') is-invalid @enderror" value="{{ old('siteurl') ?? $option->siteurl}}" placeholder="Alamat website" required>
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="url" name="homeurl" class="form-control @error('homeurl') is-invalid @enderror" value="{{ old('homeurl') ?? $option->homeurl}}" placeholder="Alamat Beranda website" required>
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea id="editor1"  rows="10" cols="80" class="form-control @error('description') is-invalid @enderror" name="description" >{{ old('description') ?? $option->description }}</textarea>
                                    ...
                                    <div class="box">
                                        ...
                                        <div class="box-body">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="url" name="facebook" class="form-control @error('facebook') is-invalid @enderror" value="{{ old('facebook')  ?? $option->facebook }}" placeholder="Alamat Facebook" required>
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" name="instagram" class="form-control @error('instagram') is-invalid @enderror" value="{{ old('instagram') ?? $option->instagram}}" placeholder="Alamat Instagram" required>
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" name="youtube" class="form-control @error('youtube') is-invalid @enderror" value="{{ old('youtube')  ?? $option->youtube}}" placeholder="Alamat Youtube Chanel" required>
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" name="twitter" class="form-control @error('twitter') is-invalid @enderror" value="{{ old('twitter')  ?? $option->twitter}}" placeholder="Alamat Twitter" required>
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" name="linkedln" class="form-control @error('linkedln') is-invalid @enderror" value="{{ old('linkedln')  ?? $option->linkedln}}" placeholder="Alamat Linkedln" required>
                                                </div>
                                    ...
                                    <div class="box">
                                        ...
                                        <div class="box-body">
                                            <div class="form-group">
                                                <h5>Whatsapp </h5>
                                                <div class="controls">
                                                    <input type="number" name="watshapp" class="form-control @error('watshapp') is-invalid @enderror" value="{{ old('watshapp') ?? $option->watshapp}}" placeholder="Nomor Whatsapp" >
                                                </div>
                                                <div class="form-control-feedback"><small><code>Nomor Whatsapp 811XXXXXXXX</code></small></div>
                                                @error('watshapp')
                                                <div class="form-control-feedback"><small> <code>{{ $message }}</code> </small></div>
                                                @enderror
                                            </div>
                                            <div class="form-group">
                                                <h5>Telegram </h5>
                                                <div class="controls">
                                                    <input type="text" name="telegram" class="form-control @error('telegram') is-invalid @enderror" value="{{ old('telegram') ?? $option->telegram}}" placeholder="username telegram" >
                                                </div>
                                            ...
                                            <div class="form-group">
                                                <h5>Phone </h5>
                                                <div class="controls">
                                                    <input type="text" name="phone" class="form-control @error('phone') is-invalid @enderror" value="{{ old('phone') ?? $option->phone}}" placeholder=" phone" >
                                                </div>
                                            ...
                                            <div class="form-group">
                                                <h5>Email </h5>
                                                <div class="controls">
                                                    <input type="email" name="email" class="form-control @error('email') is-invalid @enderror" value="{{ old('email') ?? $option->email}}" placeholder=" email" >
                                                </div>
                                            ...
                                            <div class="form-group">
                                                <h5>Address </h5>
                                                <div class="controls">
                                                    <textarea rows="5" name="address" class="form-control @error('address') is-invalid @enderror"  placeholder="address" >{{ old('address') ?? $option->address}} </textarea>
                                                </div>
                                            ...
                                            <div class="form-group">
                                                <h5>City </h5>
                                                <div class="controls">
                                                    <input type="city" name="city" class="form-control @error('city') is-invalid @enderror" value="{{ old('city') ?? $option->city}}" placeholder=" city" >
                                                </div>
                                            ...
                                            <div class="form-group">
                                                <h5>Province </h5>
                                                <div class="controls">
                                                    <input type="state" name="state" class="form-control @error('state') is-invalid @enderror" value="{{ old('state') ?? $option->state}}" placeholder=" Province" >
                                                </div>
                                            ...
                                            <div class="form-group">
                                                <h5>Country </h5>
                                                <div class="controls">
                                                    <input type="country" name="country" class="form-control @error('country') is-invalid @enderror" value="{{ old('country') ?? $option->country}}" placeholder=" country" >
                                                </div>
                                            ...
                                            <div class="form-group">
                                                <h5>Postal Code </h5>
                                                <div class="controls">
                                                    <input type="postalcode" name="postalcode" class="form-control @error('postalcode') is-invalid @enderror" value="{{ old('postalcode') ?? $option->postalcode}}" placeholder=" postalcode" >
                                                </div>
                                                    ...
                                                    <div class="form-group">
                                                        <div class=" fileinput fileinput-new" data-provides="fileinput">
                                                            <div class="fileinput-new img-thumbnail" style="width: 200px;">
                                                                <img src="{{ ($option->imageThumbUrl) ? $option->imageThumbUrl : '/assets/images/no_image.png' }}"  alt="...">
                                                            </div>
                                            ...
                                            <div class="box h-300">
                                                ...
                                                <div class="box-body text-center ">
                                                    ...
                                                    <div class="form-group">
                                                        <div class=" fileinput fileinput-new" data-provides="fileinput">
                                                            <div class="fileinput-new img-thumbnail" style="width: 200px;">
                                                                <img src="{{ ($option->faviconUrl) ? $option->faviconUrl : '/assets/images/no_image.png' }}"  alt="...">
                                                            </div>
                                                            <div class="fileinput-preview fileinput-exists img-thumbnail" style="max-width: 200px;"></div>
                                                            <div>
                                                                <span class="btn btn-outline-secondary btn-file"><span class="fileinput-new">Select image</span><span class="fileinput-exists">Change</span>
                                            ...
                                            <div class="box h-300">
                                                ...
                                                <div class="box-body text-center ">
                                                    ...
                                                    <div class="form-group">
                                                        <div class=" fileinput fileinput-new" data-provides="fileinput">
                                                            <div class="fileinput-new img-thumbnail" style="width: 200px;">
                                                                <img src="{{ ($option->LogomenuUrl) ? $option->LogomenuUrl : '/assets/images/no_image.png' }}"  alt="...">
                                                            </div>
                                                            <div class="fileinput-preview fileinput-exists img-thumbnail" style="max-width: 200px;"></div>
                                                            <div>
                                                                <span class="btn btn-outline-secondary btn-file"><span class="fileinput-new">Select image</span><span class="fileinput-exists">Change</span>
                                            ...
                                            <div class="box h-300">
                                                ...
                                                <div class="box-body text-center ">
                                                    ...
                                                    <div class="form-group">
                                                        <div class=" fileinput fileinput-new" data-provides="fileinput">
                                                            <div class="fileinput-new img-thumbnail" style="width: 200px;">
                                                                <img src="{{ ($option->BgheaderThumbUrl) ? $option->BgheaderThumbUrl : '/assets/images/no_image.png' }}"  alt="...">
                                                            </div>
                                                            <div class="fileinput-preview fileinput-exists img-thumbnail" style="max-width: 200px;"></div>
                                                            <div>
                                                                <span class="btn btn-outline-secondary btn-file"><span class="fileinput-new">Select image</span><span class="fileinput-exists">Change</span>
                                            ...
                                            <div class="box h-300">
                                                ...
                                                <div class="box-body text-center ">
                                                    ...
                                                    <div class="form-group">
                                                        <div class=" fileinput fileinput-new" data-provides="fileinput">
                                                            <div class="fileinput-new img-thumbnail" style="width: 200px;">
                                                                <img src="{{ ($option->BgstatisticThumbUrl) ? $option->BgstatisticThumbUrl : '/assets/images/no_image.png' }}"  alt="...">
                                                            </div>
                                                            <div class="fileinput-preview fileinput-exists img-thumbnail" style="max-width: 200px;"></div>
                                                            <div>
                                                                <span class="btn btn-outline-secondary btn-file"><span class="fileinput-new">Select image</span><span class="fileinput-exists">Change</span>
                                ...
                                <div class="p-15">
                                    <div class="row">
                                        <div class="box">
                                            ...
                                            <div class="box-body">
                                                <div class="form-group">
                                                    <h5>Maps </h5>
                                                    <div class="controls">
                                                        <textarea rows="5" name="maps" class="form-control @error('maps') is-invalid @enderror"  placeholder="maps" >{{ old('maps') ?? $option->maps}} </textarea>
                                                    </div>
                                        ...
                                        <div class="box">
                                            ...
                                            <div class="box-body">
                                                <iframe src="{{ $option->maps }}" class="map" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="box">
                                            ...
                                            <div class="box-body">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <textarea rows="2" name="meta_description" class="form-control @error('meta_description') is-invalid @enderror"  placeholder="meta_description" >{{ old('meta_description') ?? $option->meta_description}} </textarea>
                                                    </div>
                                            ...
                                            <div class="box-body">
                                                <div class="form-group">
                                                    <h5>Meta Keywords </h5>
                                                    <div class="controls">
                                                        <textarea rows="2" name="meta_keywords" class="form-control @error('meta_keywords') is-invalid @enderror"  placeholder="meta_keywords" >{{ old('meta_keywords') ?? $option->meta_keywords}} </textarea>
                                                    </div>
                                                    <div class="form-control-feedback">
                                                        <small> Exp:
                                                            <code>
