...
<section class="content">
    <form id="post-form" enctype="multipart/form-data" action="{{ route('backend.pages.update', $page) }}"  method="POST">
        @csrf
        @method('PUT')
        <div class="row">
                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="editor1"  rows="10" cols="80" class="form-control @error('content') is-invalid @enderror" name="content" >{{  old('content') ?? $page->content  }}</textarea>
                            @error('content')
                            <div class="form-control-feedback"><small> <code>{{ $message }}</code> </small></div>
                            @enderror
                        </div>
                    ...
                    <div class="box-body">
                        <div class="form-group @error('pagecategory_id') has-error @enderror">
                            ...
                            <select class="form-control select2" style="width: 100%;" name="pagecategory_id">
                                ...
                                <option value="{{ $item->id }}" {{ (old('pagecategory_id') == $item->id ? 'selected': '') }}
                                    @if($item->id == $page->pagecategory_id)
                                    selected
                                    @endif>
                                    {{ $item->title }}
                                </option>
                        ...
                        <div class="form-group">
                            <div class=" fileinput fileinput-new" data-provides="fileinput">
                                <div class="fileinput-new img-thumbnail" style="width: 200px;">
                                    <img src="{{ ($page->imageThumbUrl) ? $page->imageThumbUrl : '/assets/images/no_image.png' }}"  alt="...">
