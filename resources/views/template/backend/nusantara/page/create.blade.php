            ...
            <div class="d-inline-block align-items-center">
                <nav>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item" aria-current="page"><a href="{{ route('backend.pages.index') }}">All Page</a></li>
                    ...
                    <div class="box-body">
                        <div class="form-group @error('pagecategory_id') has-error @enderror">
                            ...
                            <select class="form-control select2" style="width: 100%;" name="pagecategory_id">
                                ...
                                <option value="{{ $item->id }}" {{ (old('pagecategory_id') == $item->id ? 'selected': '') }}>{{ $item->title }}</option>
                                @endforeach
                            </select>
